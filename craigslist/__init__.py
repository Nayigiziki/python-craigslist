...
class CraigslistHousing(CraigslistBase):
    ...
    extra_filters = {
        ...
        'min_bedrooms': {'url_key': 'bedrooms', 'value': None},
        'min_bathrooms': {'url_key': 'bathrooms', 'value': None},
        'max_bedrooms': {'url_key': 'bedrooms', 'value': None},
        'max_bathrooms': {'url_key': 'bathrooms', 'value': None},
